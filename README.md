...
A sleek, responsive, and fully functional web calculator built using **HTML5, CSS3, and Vanilla JavaScript**. This project features a clean UI and handles basic arithmetic operations with precision.
